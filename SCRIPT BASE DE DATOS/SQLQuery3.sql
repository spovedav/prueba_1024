...
----------------------------------------------
DECLARE @FechaInicio DATE = '2024-01-01'; -- Fecha de inicio de la semana
DECLARE @FechaFin DATE = '2024-01-08';   -- Fecha de fin de la semana
...
SELECT 
    Nombre AS Usuario,
    SUM(CASE WHEN Dia = 'Lunes' THEN CAST(Dsisponible AS INT) END) AS [Lunes],
